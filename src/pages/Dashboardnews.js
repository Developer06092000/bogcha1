    ...
    return (
      <div>
        <Container>
          ...
          <h1 style={{color:'black',border:'1px solid red'}}>Card Image with description on :hover</h1>
<div className={styles.cards} style={{border:'1px solid red'}}>
  ...
  <div className={styles.card}>
    <h2 className={styles.cardtitle}>Prezident tashrifi <br/>  <div style={{margin:'auto'}}> 14/08/2020 </div></h2>
  ...
  <div className={styles.card} style={{paddingTop:'100px'}}>
    <h2 className={styles.cardtitle}>Prezident tashrifi <br/>  <div style={{margin:'auto'}}> 14/08/2020 </div></h2>
    <img src="https://images.unsplash.com/photo-1534251369789-5067c8b8602a?ixlib=rb-1.2.1ixid=eyJhcHBfaWQiOjEyMDd9auto=formatfit=cropw=634q=80" alt=""/>
